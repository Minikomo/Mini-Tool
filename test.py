...
if mode == '5':
    ...
    def verify(token):
        ...
        verify = requests.put(f'https://discord.com/api/v9/guilds/{serverid}/requests/@me',headers=headers,json=json_data,)
        print(verify.text)
        print(verify.status_code)
    verify('MTA4MTI1OTk1NTk3OTU3MTMxMA.G2FohF.SeAamhWDB1iJk1ZUTRgbGcyVUdqGcgAcBEpjkM')
